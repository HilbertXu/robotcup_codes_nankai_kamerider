...
void initplace()
{
  ...
  littletable.position.x =  12.8627;
  littletable.position.y = 1.14987;
  littletable.position.z = 0;
  littletable.orientation.x = 0;
  littletable.orientation.y = 0;
  littletable.orientation.z = 0.662806;
  littletable.orientation.w = 0.748791;
  

  diningroom.position.x = 11.9463;
  diningroom.position.y = 2.81379;
  diningroom.position.z = 0;
  diningroom.orientation.x = 0;
  diningroom.orientation.y = 0;
  diningroom.orientation.z = -0.113013;
  diningroom.orientation.w = 0.993593;



  livingroom.position.x = 8.57897;
  livingroom.position.y = 3.25528;
  livingroom.position.z = 0;
  livingroom.orientation.x = 0;
  livingroom.orientation.y = 0;
  livingroom.orientation.z =  -0.0857846;
  livingroom.orientation.w =  0.996314;

  coffeetable.position.x = 10.3498;
  coffeetable.position.y = 4.37952;
  coffeetable.position.z = 0;
  coffeetable.orientation.x = 0;
  coffeetable.orientation.y = 0;
  coffeetable.orientation.z = 0.735302;
  coffeetable.orientation.w = 0.67774;
...
ROS_INFO("qwer123!");
	...
	{
                ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
...
int main(int argc, char** argv)
{
	...
	while(ros::ok())
	{
		...
		if((go==true))
		{
                        ROS_INFO("fafafdfdsfdsfdsfdsfdsfs");
ROS_INFO("fafafdfdsfdsfdsfdsfdsfs");ROS_INFO("fafafdfdsfdsfdsfdsfdsfs");ROS_INFO("fafafdfdsfdsfdsfdsfdsfs");ROS_INFO("fafafdfdsfdsfdsfdsfdsfs");ROS_INFO("fafafdfdsfdsfdsfdsfdsfs");
			...
			naviGoal.target_pose.header.frame_id = "map"; 
			naviGoal.target_pose.header.stamp = ros::Time::now();
			naviGoal.target_pose.pose = geometry_msgs::Pose(littletable);
